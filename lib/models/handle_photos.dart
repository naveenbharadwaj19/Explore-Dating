...
class HandlePhotos {
  ...
  // ? head photo options
  static Future<void> openCameraForHeadPhoto(Function updateHeadPhoto,BuildContext context) async {
    try {
      final picker = ImagePicker();
      // * using 1 : 1 aspect ratio
      final imageFile = await picker.getImage(source: ImageSource.camera,maxWidth: 400,maxHeight: 400,imageQuality: 95);
  ...
  static Future<void> openGalleryForHeadPhoto(Function updateHeadPhoto,BuildContext context) async {
    try {
      final picker = ImagePicker();
      // * using 1 : 1 aspect ratio
      final imageFile = await picker.getImage(source: ImageSource.gallery,maxWidth: 400,maxHeight: 400,imageQuality: 95);
      // final compressedImage = await FlutterNativeImage.compressImage(imageFile.path,targetWidth: 400,targetHeight: 400,quality: 100);
      print("Path : ${imageFile.path}");
      headPhoto = imageFile.path;
      updateHeadPhoto();
  ...
  // ? body photo options
  static Future<void> openCameraForBodyPhoto(Function updateBodyPhoto,BuildContext context) async {
    try {
      final picker = ImagePicker();
      // * using 1 : 1 aspect ratio
      final imageFile = await picker.getImage(source: ImageSource.camera,maxWidth: 1080,maxHeight: 1080,imageQuality: 95);
  ...
  static Future<void> openGalleryForBodyPhoto(Function updateBodyPhoto,BuildContext context) async {
    try {
      final picker = ImagePicker();
      // * using 1 : 1 aspect ratio
      final imageFile = await picker.getImage(source: ImageSource.gallery,maxWidth: 1080,maxHeight: 1080,imageQuality: 95);
      // final compressedImage = await FlutterNativeImage.compressImage(imageFile.path,targetWidth: 1080,targetHeight: 1080,quality: 100);
      print("Path : ${imageFile.path}");
      bodyPhoto = imageFile.path;
      updateBodyPhoto();
